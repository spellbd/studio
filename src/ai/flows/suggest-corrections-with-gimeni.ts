...
১. **বানান এবং ব্যাকরণগত ভুল**: যেকোনো ভুল বানান বা ব্যাকরণগত ভুল চিহ্নিত করুন। প্রতিটি ভুলের জন্য, আপনাকে অবশ্যই মূল শব্দটি, যে প্রসঙ্গে এটি উপস্থিত হয়েছে, একটি স্বতন্ত্র আইডি এবং সঠিক পরামর্শগুলির একটি তালিকা সরবরাহ করতে হবে।

২. **ফরম্যাটিং ও বিরামচিহ্ন**: ফরম্যাটিংয়ে অসামঞ্জস্য সন্ধান করুন, যেমন স্পেসিং, অ্যালাইনমেন্ট বা যতিচিহ্নের ব্যবহারে সমস্যা। অনুপস্থিত দাঁড়ি (।), কমা (,), সেমিকোলন (;) ইত্যাদির মতো বিরামচিহ্ন যোগ করার পরামর্শ দিন। প্রতিটি পরামর্শের জন্য একটি শিরোনাম, একটি বর্ণনামূলক ব্যাখ্যা দিন। যদি সম্ভব হয়, তাহলে একটি স্বয়ংক্রিয় সমাধানের জন্য মূল টেক্সট (originalText) এবং প্রতিস্থাপিত টেক্সট (replacementText) সরবরাহ করুন।
...
৩. **কাঠামোগত পরামর্শ এবং ভাষারীতি**:
   ...
   - **বাক্য গঠন**: শিরোনাম, অনুচ্ছেদের দৈর্ঘ্য এবং বাক্যের স্পষ্টতা উন্নত করার জন্য পরামর্শ দিন।

৪. **ভাষারীতি ও শব্দচয়ন**: লেখার ভাব বা টোন পরীক্ষা করুন এবং বিকল্প শব্দ பரிந்து করুন যা প্রসঙ্গের সাথে আরও ভালভাবে খাপ খায় বা সামগ্রিক ভাবকে উন্নত করে (যেমন, এটিকে আরও আনুষ্ঠানিক, বিশ্বাসযোগ্য বা স্পষ্ট করে তোলে)। প্রতিটি পরামর্শের জন্য, মূল শব্দটি, এর প্রসঙ্গ, প্রস্তাবিত প্রতিস্থাপন এবং পরিবর্তনের জন্য একটি সংক্ষিপ্ত ব্যাখ্যা সরবরাহ করুন।

আপনার বিশ্লেষণটি একটি JSON অবজেক্টে চারটি কী দিয়ে ফেরত দিন: 'spellingErrors', 'formattingSuggestions', 'structuralSuggestions', এবং 'toneSuggestions'। প্রতিটি কী-তে আপনার পাওয়া সমস্যাগুলির সাথে সম্পর্কিত অবজেক্টগুলির একটি অ্যারে থাকা উচিত। যদি আপনি কোনো বিশেষ ধরণের কোনো সমস্যা খুঁজে না পান, তবে সেই কী-এর জন্য একটি খালি অ্যারে ফেরত দিন।

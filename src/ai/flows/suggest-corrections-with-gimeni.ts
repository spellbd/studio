...
১. **বানান এবং ব্যাকরণগত ভুল (Spelling and Grammar)**: যেকোনো ভুল বানান বা ব্যাকরণগত ভুল চিহ্নিত করুন। প্রতিটি ভুলের জন্য, আপনাকে অবশ্যই মূল শব্দটি, যে প্রসঙ্গে এটি উপস্থিত হয়েছে, একটি স্বতন্ত্র আইডি এবং সঠিক পরামর্শগুলির একটি তালিকা সরবরাহ করতে হবে। (JSON output key: "spellingErrors")
...
৩. **কাঠামোগত পরামর্শ এবং ভাষারীতি (Structure and Style)**:
...
৪. **ভাষারীতি ও শব্দচয়ন (Tone and Diction)**: লেখার ভাব বা টোন পরীক্ষা করুন এবং বিকল্প শব্দ பரிந்து করুন যা প্রসঙ্গের সাথে আরও ভালভাবে খাপ খায় বা সামগ্রিক ভাবকে উন্নত করে (যেমন, এটিকে আরও আনুষ্ঠানিক, বিশ্বাসযোগ্য বা স্পষ্ট করে তোলে)। প্রতিটি পরামর্শের জন্য, মূল শব্দটি, এর প্রসঙ্গ, প্রস্তাবিত प्रतिस्थापन এবং পরিবর্তনের জন্য একটি সংক্ষিপ্ত ব্যাখ্যা সরবরাহ করুন। (JSON output key: "toneSuggestions")

আপনার বিশ্লেষণটি একটি JSON অবজেক্টে চারটি কী ('spellingErrors', 'formattingSuggestions', 'structuralSuggestions', এবং 'toneSuggestions') দিয়ে ফেরত দিন। যদি আপনি কোনো বিশেষ ধরণের কোনো সমস্যা খুঁজে না পান, তবে সেই কী-এর জন্য একটি খালি অ্যারে ([]) ফেরত দিন।

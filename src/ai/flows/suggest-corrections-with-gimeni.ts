...
৩. **কাঠামোগত পরামর্শ**: নথির समग्र কাঠামো বিশ্লেষণ করুন। নথির ধরণ (যেমন: আবেদনপত্র, প্রতিবেদন, ইত্যাদি) সনাক্ত করুন এবং সেই ধরণের জন্য প্রয়োজনীয় কিন্তু অনুপস্থিত অংশগুলো (যেমন: বিষয়, তারিখ, স্বাক্ষর) যোগ করার জন্য পরামর্শ দিন। শিরোনাম, অনুচ্ছেদের দৈর্ঘ্য, বাক্যের स्पष्टता এবং পাঠযোগ্যতায় সমস্যা সন্ধান করুন। প্রতিটি পরামর্শের জন্য একটি শিরোনাম, বিবরণ এবং সম্ভব হলে, একটি স্বয়ংক্রিয় সমাধানের জন্য originalText এবং replacementText সরবরাহ করুন।

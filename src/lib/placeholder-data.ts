...
export const mockFormattingSuggestions: FormattingSuggestion[] = [
    ...
    },
    {
      id: 'fmt-comma',
      title: 'অনুপস্থিত কমা',
      description: 'সম্বোধনের পর একটি কমা (,) ব্যবহার করা উচিত। "মহোদয়" এর পরে একটি কমা যোগ করুন।',
      originalText: 'মহোদয়',
      replacementText: 'মহোদয়,',
    },
    {
      id: 'fmt-dandari',
      title: 'অনুপস্থিত দাঁড়ি',
      description: 'বাক্যটি একটি দাঁড়ি (।) দিয়ে শেষ হওয়া উচিত। "দশম শ্রেনি" এর পরে একটি দাঁড়ি যোগ করুন।',
      originalText: 'দশম শ্রেনি',
      replacementText: 'দশম শ্রেনি।',
    }
];
...
export const mockStructuralSuggestions: StructuralSuggestion[] = [
    {
      id: 'struct-date',
      title: 'অনুপস্থিত "তারিখ"',
      description: 'আবেদনপত্রের শুরুতে একটি তারিখ উল্লেখ করা আবশ্যক। সাধারণত এটি প্রাপকের ঠিকানার আগে বা পরে লেখা হয়।',
      originalText: 'প্রধান শিক্ষক',
      replacementText: 'তারিখ: ২০ জুন, ২০২৪\n\nপ্রধান শিক্ষক',
    },
    {
      id: 'struct-subject',
